    ...
    <div class="container mx-auto md:flex">
        <div class="md:w-1/2" data-post-id="{{ $post->id }}">
            ...
            <div class="p-3 flex items-center gap-3">
                @auth
                    @if ($post->checkLike(Auth::user()))
                        <form class="formulario_likes__dislike" action="{{ route('posts.likes.destroy', $post) }}" method="POST">
                            ...
                            <div class="my-4">
                                <button>
                                    <svg id="corazon_like" xmlns="http://www.w3.org/2000/svg" fill="blue" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                ...
                <p class="font-bold"><span class="contador_likes">{{ $post->likes->count() }}</span>  Likes</p>
            </div>
