...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        {{-- stack es para agregar hojas que no esten en todas la vista --}}
        @stack('styles')
        <!-- Agregar vite para estilos -->
        @vite('resources/css/app.css')
        <!-- Agregar vite para scripts -->
        ...
        <header class="p-5 border-b bg-white shadow">
            <div class="container mx-auto flex justify-between items-center">
                ...
                <nav class="flex gap-3 items-center">
                    ...
                    <a href="{{ route('posts.create') }}" class="flex items-center gap-2 bg-white border p-2 text-gray-600 font-bold cursor-pointer">
